...
![Kiro for Codex IDE – CodeLens & Views](image.png)
...
- From VSIX (alternative):
  ...
  - CLI: `code --install-extension ./kiro-for-codex-ide-x.y.z.vsix`
...
## Repository / Credits
- GitHub: [atman-33/kiro-for-codex-ide](https://github.com/atman-33/kiro-for-codex)
